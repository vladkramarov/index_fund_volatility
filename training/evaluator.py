...
def plot_results_over_time(data: pd.DataFrame, days_ahead: int = 1, overwrite_in_the_folder: bool = False):
...
def plot_metrics_over_horizons(data: pd.DataFrame, metric_name: str = 'mape', overwrite_in_the_folder: bool = False):
