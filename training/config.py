...
HIDDEN_CONTINUOUS_SIZE = 48 #56 #29 #44 
ATTENTION_HEADS = 5 #6 #4
...
TIME_VARYING_KNOWN_CATEGORICALS= ['month',  'cpi_report_new', "day_of_the_week",  'day_of_the_month', \
                                  'monthly_options_expiration_new', 'quadruple_witching_new', 'earnings_period_new', 'election_dates_new']    
...
FEATURES_TO_ENRICH = ['monthly_options_expiration', 'quadruple_witching', 'election_dates', 'cpi_report']
