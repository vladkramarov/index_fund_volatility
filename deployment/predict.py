...
def predict(processed_data: pd.DataFrame) -> Prediction:
...
def process_output(preds: Prediction, prediction_start_date: str, processed_data: pd.DataFrame) -> pd.DataFrame:
